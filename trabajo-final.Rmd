...
```{r}
set.seed(5)
synth <- tibble(a = c(runif(50, min = 0, max = 1), runif(50, min = 1.1, max = 2)-0.3),
       b = c(runif(50, min = 0, max = 1), runif(50, min = 1.1, max = 2)-0.3),
       resp = as_factor(c(rep("clase 1", 50), rep("clase 2", 50)))) 
...
En este caso, la máquina de soporte vectorial con kernel lineal y costo alto, tiene también una clasificación buena en el conjunto de prueba, pero comete un solo error al predecir incorrectamente una observación con valor verdadero en la clase 2.
