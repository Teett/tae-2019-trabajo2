...
glm_test_syntetic_quadratic_class <- tibble(pred = as.factor(response_predict_test_syntetic_quadratic) ,
                        real = syntetic_quadratic_test$y)

glm_test_syntetic_quadratic_class %>% conf_mat(truth = real, estimate = pred) %>% 
  autoplot(type = "heatmap") + 
