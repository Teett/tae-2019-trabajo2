...
syntetic_quadratic <- tibble(x1_values, x2_values, as.factor(y))
...
g <- ggplot(data = syntetic_quadratic) + 
  geom_point(mapping = aes(x = x1_values, y = x2_values, color = y)) +
...
Tomando en cuenta los datos construidos en los literales anteriores, vamos a entrenar un modelo de regresión logística.